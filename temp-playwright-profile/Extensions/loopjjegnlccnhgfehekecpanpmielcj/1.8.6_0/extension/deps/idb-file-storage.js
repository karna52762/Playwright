(function (global, factory) {
    ...
    class IDBFileStorage {
      ...
      async put(fileName, file) {
        ...
        if (!(file instanceof ArrayBuffer) && !(file instanceof File) && !(file instanceof Blob) && !(window.IDBMutableFile && file instanceof window.IDBMutableFile) && !(file instanceof IDBPromisedMutableFile)) {
